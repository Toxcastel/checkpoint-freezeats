...
const Order = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put("api/order/checkout").catch((err) => {
            console.log(err);
        });
        navigate("/resume");
    };
    ...
    const handleRejected = (e) => {
        e.preventDefault();
        axios.put("api/order/rejected").catch((err) => {
            console.log(err);
        });
        navigate("/");
    };
    ...
    return (
        ...
        >
                ...
                {shipping === "envio" ? (
                    !address.number ? (
                        ...
                        <>
                            ...
                            >
                                <Avatar
                                    src="https://marketplace.canva.com/FUmOY/MAEPzDFUmOY/1/tl/canva-green-location-pin-icon-MAEPzDFUmOY.png"
                                    variant="square"
                                    sx={{ width: 40, height: 40, pl: 1 }}
                                ></Avatar>
                                <Box
                                    sx={{
                                        p: 2,
            ...
            >
                <Typography
                    variant="h5"
                    sx={{ mt: 8, mb: 1, color: "white", fontWeight: "bold" }}
                >
                    Resumen de compra
                </Typography>
